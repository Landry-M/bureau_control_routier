<?php
/* Variables expected from PermisTemporaireController:
 * $numero (string) - Numéro du permis temporaire
 * $date_debut (string Y-m-d) - Date de début
 * $date_fin (string Y-m-d) - Date de fin
 * $nom, $prenom, $numero_national, $adresse, $nationalite
 * $date_naissance, $lieu_naissance, $photoSrc
 */
        ...
        <div class="content">
            ...
            <div class="right-section">
                ...
                <div class="field field-wide">
                    ...
                    <span class="value">PERMIS TEMPORAIRE</span>
                </div>
                <div class="field">
